...
class Groq extends OpenAI {
    constructor(init){
        const { apiKey = getEnv("GROQ_API_KEY"), additionalSessionOptions = {}, model = "llama-3.3-70b-versatile", ...rest } = init ?? {};
        super({
            apiKey,
        ...
        this.lazySession = async ()=>new GroqSDK({
                apiKey,
