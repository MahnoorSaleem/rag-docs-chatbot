import { pipeline, FeatureExtractionPipeline, PreTrainedTokenizer, PreTrainedModel } from '@huggingface/transformers';
import { BaseEmbedding } from '@llamaindex/core/embeddings';
import { LoadTransformerEvent } from '@llamaindex/env/multi-model';
...
declare class HuggingFaceLLM extends BaseLLM {
    ...
    protected streamChat(params: LLMChatParamsStreaming): Promise<never>;
}
/**
 ...
 */
declare const huggingface: (init?: ConstructorParameters<typeof HuggingFaceLLM>[0]) => HuggingFaceLLM;
...
export { HuggingFaceEmbedding, HuggingFaceEmbeddingModelType, HuggingFaceInferenceAPI, HuggingFaceInferenceAPIEmbedding, HuggingFaceLLM, huggingface };
export type { HFConfig, HFLLMConfig, HuggingFaceEmbeddingParams };
