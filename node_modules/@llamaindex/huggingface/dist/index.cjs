...
var multiModel = require('@llamaindex/env/multi-model');
 ...
 */ class HuggingFaceInferenceAPIEmbedding extends embeddings.BaseEmbedding {
    constructor(init){
        ...
        this.hf = new inference.HfInference(accessToken, hfInferenceOpts);
        this.model = model;
 ...
 */ class HuggingFaceInferenceAPI extends llms.BaseLLM {
    static{
    ...
    async *streamChat(params) {
        ...
        yield* utils.streamConverter(stream, (chunk)=>({
 ...
 *
 * @extends BaseEmbedding
 */ class HuggingFaceEmbedding extends embeddings.BaseEmbedding {
    constructor(params = {}){
    ...
    async getExtractor() {
        if (!this.extractor) {
            const { pipeline } = await multiModel.loadTransformers((transformer)=>{
...
class HuggingFaceLLM extends llms.BaseLLM {
    static{
    ...
    async getTokenizer() {
        const { AutoTokenizer } = await multiModel.loadTransformers((transformer)=>{
            global.Settings.callbackManager.dispatchEvent("load-transformers", {
                transformer
            }, true);
        });
    ...
    async getModel() {
        const { AutoModelForCausalLM } = await multiModel.loadTransformers((transformer)=>{
            global.Settings.callbackManager.dispatchEvent("load-transformers", {
                transformer
            }, true);
        });
...
exports.HuggingFaceEmbeddingModelType = HuggingFaceEmbeddingModelType;
exports.HuggingFaceInferenceAPI = HuggingFaceInferenceAPI;
